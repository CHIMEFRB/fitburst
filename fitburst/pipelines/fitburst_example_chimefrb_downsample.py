...
data.downsample(factor_freq=1, factor_time=4)
...
data_windowed, times_windowed = data.window_data(params["arrival_time"][0], window=0.04)
...
ut.plotting.plot_summary_triptych(
    ...
    residuals = bestfit_residuals * fitter.weights[:, None]
)
